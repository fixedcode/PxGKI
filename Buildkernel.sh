...
export Security_Patch="2025-04"

# Kernel Suffix
# Set (Kernel_Suffix="") meaning delete dirty suffix
# or using custom suffix to replace it
# Recommend same as stock kernel
export Kernel_Suffix="gd4aed7ed470e-ab13759939-4k"

# Kernel Build Timestamp
# Recommend same as stock kernel
export Kernel_Time="Thu Jul 10 03:15:03 UTC 2025"
...
# Install toolkit ( default use APT )
...
echo -e "\e[32mSetup susfs and manual hooks\e[0m"
cd $HOME/PxGKI/Buildkernel
...
cd common
patch -p1 < 50_add_susfs_in_gki-android$Android_Release-$Kernel_Version.patch
...
echo -e "\e[33m[Done]\e[0m" Add susfs configuration to kernel
